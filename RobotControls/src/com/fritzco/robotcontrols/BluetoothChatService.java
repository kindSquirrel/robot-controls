...
public class BluetoothChatService {
    ...
    public static final int STATE_FAILED_TO_CONNECT = 4;// tried and failed.  manual restart for now
    public static final int STATE_CONNECTION_LOST = 5; // had it, but lost it... manual restart for now

    private boolean Stopped; // flag for really stopping and not restarting threads.
    /**
    ...
    private void connectionFailed() {
        ...
        //msg.setData(bundle);
        //mHandler.sendMessage(msg);
    	setState(STATE_FAILED_TO_CONNECT);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (!line.equals(""))  {
                    	bytes = line.length();
                    	line.getChars(0, bytes, buffer, 0);
                    	buffer[bytes] = '\n';  // adding back CR after trimmed by readline
